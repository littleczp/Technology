...
此时的你，已经对想制作的游戏有了一些想法。那就让我们将这些想法整理成大纲。
...
每一个核心模块必须单独讨论，在所有问题一一确认后，最终得到一个完整的游戏设计。设计至少应该包含：核心玩法（核心循环）、内容与结构（关卡/流程设计）、叙事与世界观（可选）、美术风格。
与我进行确认暂时没有要解决的问题后，输出为一份《游戏设计》文件（.md格式）
